...
// console.log(mockFetchMissions) <- commented out to clear test term
...
// this test is using the JS feature async/await
test("clickon the button fetches data", async () => {
...
// wait for data
await waitFor(() => expect (queryAllByTestId(/mission-list/i)).toHaveLength(3))
// query for the missions array  / assert it's rendering
});

// dev tools - network - response - copy - json to js paste 
// your json in js now woo!